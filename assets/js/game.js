// Function to determine if fight continues or is skipped
...
var fight = function(enemy) {
    ...
    while (enemy.health > 0 && playerInfo.health > 0) {
        ...
        // Get valid response from user to fight or skip, if true break out of fight
        if (fightOrSkip()) {
            break;
        }
